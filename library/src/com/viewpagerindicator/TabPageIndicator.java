...
public class TabPageIndicator extends HorizontalScrollView implements
	...
	private int selectedColor;// the text color when its tab is selected
	private int defaultColor;// the text color when its tab not selected
	 ...
	 * @author yemeng
	 * @date 2014-8-23
	 * @function set the color of the tabview
	 * @param view
	 * @param selectedColor
	 * @param defaultColor
	 */
	public void setViewPager(ViewPager view, int selectedColor, int defaultColor) {
	...
	public void setCurrentItem(int item) {
		...
		for (int i = 0; i < tabCount; i++) {
			...
			if (isSelected) {
				((TabView) child).setTextColor(selectedColor);
				animateToTab(item);
			} else {
				((TabView) child).setTextColor(defaultColor);
			}
		}
	}
