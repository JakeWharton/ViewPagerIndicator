...
public class TabPageIndicator extends HorizontalScrollView implements
	...
	private indicatorInterface viewProvider;
	...
	public void setViewProvider(indicatorInterface viewProvider) {
		this.viewProvider = viewProvider;
	}
	...
	private void addTab(int index, CharSequence text, int iconResId) {
		final CustomTabView tabView = new CustomTabView(getContext(), index,
				viewProvider.getView(index));
