...
public class LinePageIndicator extends View implements PageIndicator {
    ...
    public LinePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        final int defaultUnselectedColor = res.getColor(R.color.default_underline_indicator_unselected_color);
        final float defaultLineWidth = res.getDimension(R.dimen.default_underline_indicator_line_width);
        final float defaultGapWidth = res.getDimension(R.dimen.default_underline_indicator_gap_width);
        final float defaultStrokeWidth = res.getDimension(R.dimen.default_underline_indicator_stroke_width);
        final boolean defaultCentered = res.getBoolean(R.bool.default_underline_indicator_centered);
